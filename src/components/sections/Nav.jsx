      ...
      <Container className="flex justify-between items-center gap-3">
        ...
        <nav className="flex items-center">
          ...
          <ul className="absolute top-0 left-0 w-full bg-white shadow-md z-10 transition -translate-y-full sm:hidden" ref={menuRef}>
            <Container>
              <li>
                <a href="#" className="font-medium text-primary hover:text-secondary transition-colors py-3 block">Work</a>
              </li>
              <li>
                <a href="#" className="font-medium text-primary hover:text-secondary transition-colors py-3 block">About</a>
              </li>
              <li>
                <a href="#" className="font-medium text-primary hover:text-secondary transition-colors py-3 block">Blog</a>
              </li>
              <li>
                <a href="#" className="font-medium text-primary hover:text-secondary transition-colors py-3 block">Contact</a>
              </li>
            </Container>
          </ul>
        </nav>
